...
export default class DataAccess {
     ...
     * @param cb The function can called after roll back transaction.
     */
    static async executeTransaction<T>(exec: (queryRunner: QueryRunner)=> T, queryRunner?: QueryRunner, cb?: any): Promise<T> {
        let result: T;
